...
#import "ThreeTouchMainVC.h"
#import "ThreeTouchVC.h"

static NSString *reusedId = @"3dTouchVC";

@interface ThreeTouchMainVC ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation ThreeTouchMainVC
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ThreeTouchVC *presentationVC = [[ThreeTouchVC alloc] init];
